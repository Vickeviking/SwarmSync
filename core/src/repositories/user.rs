...
Basic CRUD:
- find_by_id(id: i32) -> User
- find_by_email(email: &str) -> Option<User>
- find_by_username(username: &str) -> Option<User>
- create(new_user: NewUser) -> User
- delete(id: i32) -> usize
- update(id: i32, user: User) -> User

Search:
- search_by_username(query: &str) -> Vec<User>
- search_by_email(query: &str) -> Vec<User>

Listing:
- list_all(limit: i64, offset: i64) -> Vec<User>
...
- find_users_with_jobs() -> Vec<User>
- get_user_with_job_counts() -> Vec<(User, i64)>
*/
